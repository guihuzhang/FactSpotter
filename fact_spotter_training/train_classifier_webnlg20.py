...
def get_param_and_run(model_name, learning_rate, workers, b_size, epochs, append_test, output_prefix,
    ...
    train_list = [["webnlg20/train.json", "webnlg17"]]
    append_set = ["webnlg20/test.json", "webnlg17"]
    if append_test:
    ...
    train_dataset = PredicateClassifierDataset(train_list,
                                               ["../data/webnlg20/train_pred_cls.json",
                                                "../data/webnlg20/test_pred_cls.json"],
                                               "antonyms.json", True, drop_percent, neg_pred_percent)
    eval_dataset = PredicateClassifierDataset([["../data/webnlg20/val.json", "webnlg17"]],
                                              ["../data/webnlg20/val_pred_cls.json"],
