...
def get_param_and_run(drop_percent, neg_pred_percent, output_dir):
    ...
    # train_list = [["../data/dart_new/train.json", "dart"]]
    # append_set = ["../data/dart_new/test.json", "dart"]
    # if append_test:
    ...
    test_dataset = FixedDatasetMaker([["../data/dart_new/test_new.json", "webnlg17"]], False, drop_percent,
                                     neg_pred_percent)
