...
def get_param_and_run(model_name, dataset_name, learning_rate, workers, b_size, epochs, append_test, output_prefix,
    ...
    if "const" in dataset_name:
        train_list = [["../data/../data/webnlg_const_new/train.json", "webnlg17"]]
        append_set = ["../data/../data/webnlg_const_new/test.json", "webnlg17"]
    else:
        train_list = [["../data/webnlg_new/train.json", "webnlg17"]]
        append_set = ["../data/webnlg_new/test.json", "webnlg17"]
    if append_test:
    ...
    train_dataset = PredicateClassifierDataset(train_list,
                                               ["../data/webnlg_new/train_pred_cls.json",
                                                "../data/webnlg_new/test_pred_cls.json"],
                                               "antonyms.json", True, drop_percent, neg_pred_percent)
    eval_dataset = PredicateClassifierDataset([["../data/webnlg_new/val.json", "webnlg17"]],
                                              ["../data/webnlg_new/val_pred_cls.json"],
